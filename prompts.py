...
_DEFAULT = {
    ...
    "scene": {
        ...
        "user": (
            ...
            "{scene_beat}\n\n"
            "Use the previous scene for continuity of facts and voice only — "
            "never copy its shape. Do not reuse its closing device, its "
            "opening move, or a rhetorical formula it ended on (for example a "
            "list of questions, a one-line revelation, a repeated refrain). "
            "Each scene must begin and end in its own way.\n\n"
